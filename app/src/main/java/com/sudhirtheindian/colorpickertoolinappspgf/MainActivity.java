package com.sudhirtheindian.colorpickertoolinappspgf;
...
public class MainActivity extends AppCompatActivity {
    // text view variable to set the color for  text
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // register the  text with appropriate ID
